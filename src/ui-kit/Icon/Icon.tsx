...
export const Icon: React.FC<IIconProps> = ({className, size, type, onClick, ...rest}) => {
  return (
    <div className={classNames("Icon", className, `Icon-IconSize__${size}`)} onClick={onClick} {...rest}>
      {getIcon(type)}
    </div>
  );
};